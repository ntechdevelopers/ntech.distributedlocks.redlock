...
namespace Ntech.RedLock
{
    public class CacheService : ICacheService
    {
        ...
        public CacheService(IDatabase database, IDistributedLockFactory distributedLockFactory, IOptions<RedisConfiguration> options)
        {
            if (options == null)
            {
        ...
        public async Task<LockProcessResult<TInput>> DoActionWithLockAsync<TInput>(string lockKey, TInput parameter, Func<TInput, Task> processor)
        {
